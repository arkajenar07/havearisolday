  ...
  return (
    <div className="flex flex-col h-screen">
      ...
      <main className="flex flex-1 flex-col items-center justify-center overflow-hidden gap-y-[36px]">
        <h1 className=" text-[20px] sm:text-[28px] md:text-[34px] lg:text-[38px] xl:text-[42px]">Unfortunately, <span className="font-bold">Projects</span> is not yet available</h1>
